...
COPY --from=builder /usr/local/lib/php/extensions/no-debug-non-zts-20230831/memcached.so /usr/local/lib/php/extensions/no-debug-non-zts-20230831/memcached.so
